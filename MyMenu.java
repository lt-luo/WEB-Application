...
public class MyMenu {
    ...
    public void setMenuBar(){
        ...
        MenuItem file = new MenuItem(menu, SWT.CASCADE|SWT.BORDER);
        file.setText("&File");
        ...
        // 设置favour菜单
       MenuItem favoutites = new MenuItem(menu, SWT.CASCADE);
       favoutites.setText("Like");
